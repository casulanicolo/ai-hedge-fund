"""
01_backtest_fundamentals.py  –  Athanor Alpha | Backtest F4
============================================================
Backtest ISOLATO del Fundamentals Agent (Categoria A).
...
def run_backtest():
    print("=" * 65)
    print("  ATHANOR ALPHA – F4  |  Backtest: Fundamentals Agent")
    ...
    scores_path = os.path.join(RESULT_DIR, "01_fundamentals_scores.csv")
    ...
    summary_rows = [
        ...
        {"metrica": "Debt/Equity medio",   "valore": round(df["s_debt_equity"].mean(), 1)},
    ...
    summary_path = os.path.join(RESULT_DIR, "01_fundamentals_summary.csv")
    ...
    print(f"    Debt/Equity     : {df['s_debt_equity'].mean():.1f}")
