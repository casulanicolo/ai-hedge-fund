"""
02_backtest_risk_manager.py  –  Athanor Alpha | Backtest F4
============================================================
...
def run_backtest():
    print("=" * 65)
    print("  ATHANOR ALPHA – F4  |  Backtest: Risk Manager")
    ...
    # ── Salvataggio CSV ───────────────────────────────────────────────────────
    var_path  = os.path.join(RESULT_DIR, "02_risk_var.csv")
    corr_path = os.path.join(RESULT_DIR, "02_risk_correlation.csv")
    summ_path = os.path.join(RESULT_DIR, "02_risk_summary.csv")
