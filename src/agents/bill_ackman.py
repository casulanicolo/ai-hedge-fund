...
def bill_ackman_agent(state: AgentState, agent_id: str = "bill_ackman_agent"):
    ...
    for ticker in tickers:
        ...
        ackman_direction = apply_ema_filter(ackman_output.direction, state, ticker)
        levels = compute_trade_levels(ackman_direction, state, ticker)
        ackman_analysis[ticker] = {
            "direction":       ackman_direction,
