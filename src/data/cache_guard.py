...
Logica: salta il LLM se TUTTE e tre queste condizioni sono vere:
    1. Esiste un segnale in cache per (agent_id, ticker) < 24h
    2. Variazione prezzo nelle ultime 24h < 1.5%
...
CACHE_MAX_AGE_HOURS    = 24.0  # ore — età massima del segnale cached
...
def should_use_cache(agent_id: str, ticker: str, state: dict) -> bool:
    ...
    # --- Controllo 1: esiste un segnale in cache valido? ---
